                    ...
                    return (
                        <View style={{ width: 360, alignItems: 'center' }}>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[0].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[1].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[2].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[3].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[4].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[5].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[6].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[7].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[8].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[9].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[10].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[11].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[12].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[13].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[14].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[15].stats[7].displayValue}</Text>
                                <View style={{ width: 25 }}></View>
                                <Text>{item.standings.entries[15].stats[11].value.toFixed(2)}%</Text>
